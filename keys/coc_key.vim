...
"inoremap <silent><expr> <C-p> coc#pum#visible() ? coc#pum#pre : "\<C-n>"
...
nmap <silent> gd :<C-u> TagImposterAnticipateJump <Bar> call CocActionAsync('jumpDefinition')<CR>
nmap <silent> gy <Plug>(coc-type-definition)
"nmap <silent> gi <Plug>(coc-implementation)
nmap <silent> gi :<C-u> TagImposterAnticipateJump <Bar> call CocActionAsync('jumpImplementation')<CR>
